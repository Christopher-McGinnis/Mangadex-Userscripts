...
;export var GrammarError: any
    ...
    export interface Parser<Ast = any> {
        parse(input: string ,options?: ParserOptions): Ast;
    ...
    export function generate<Ast = any>(grammar: string ,options?: ParserBuildOptions): Parser<Ast>
