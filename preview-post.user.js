...
function makePreview(txt) {
    ...
    let astHtml = pegAstToHtml_v2(bbcodePegParser_v2.parse(txt));
    ...
    forms.forEach((forum) => {
        ...
        function scrollToPos(pos = textarea.selectionStart) {
            ...
            if (elm) {
                ...
                if (elm.nodeType === 3) {
                    //@ts-ignore
                    const y = elm.getBoxQuads()[0].p1.y;
        ...
        function UpdatePreview() {
            ...
            let [newPreview, newAstHtml] = makePreview(textarea.value);
